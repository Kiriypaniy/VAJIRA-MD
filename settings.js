...
const FOOTERNAME = '> PANDA -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '94773864956' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=zMdn0AbB#eICkJkOj9roYXvOT93hH8VKDPdOW6KSEMblKhzqF5Ks' ,
...
FOOTER: process.env.FOOTER || '‌👨‍💻 PANDA -  ＭＤ - Ｖ5 👨‍💻',    
